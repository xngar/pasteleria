...
export default function LoyaltyAndReviews() {
  return (
    <section id="opiniones" className="bg-[#FDF0D5] px-4 sm:px-6 pb-12 scroll-mt-16">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          {/* Left Side: Loyalty Card (5 cols) */}
          <div className="lg:col-span-5 bg-[#C1121F] rounded-[32px] p-6 sm:p-7 flex flex-row items-center justify-between gap-4 shadow-md relative overflow-hidden">
            {/* Text & Button */}
            <div className="text-white z-10 flex-1">
              ...
              <p className="text-[#fdf0d5] text-xs sm:text-sm font-medium leading-relaxed mb-4">
                Gana puntos en cada pedido<br />y desbloquea premios deliciosos.
              </p>
              <button className="bg-[#003049] hover:bg-[#780000] transition-all duration-200 text-white font-bold text-xs tracking-wider uppercase px-6 py-2.5 rounded-full shadow-md hover:scale-105">
                ÚNETE Y GANA
              </button>
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-3">
              <span className="text-[#669bbc] text-base font-bold">✦</span>
              <h3 className="text-[#003049] font-extrabold text-lg sm:text-xl font-serif italic">
Amados por nuestros golosos
              </h3>
              <span className="text-[#c1121f] text-base font-bold">✦</span>
            </div>
            ...
            <p className="text-[#C1121F] font-semibold text-xs text-center lg:text-right mt-2 font-nunito">
