    ...
    <section id="ofertas" className="bg-[#FFF0E8] px-4 sm:px-6 pb-10 scroll-mt-16">
      <div className="container mx-auto max-w-6xl">
        <div className="bg-[#FF9F1C] rounded-[32px] px-6 py-6 sm:px-8 sm:py-8 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-md relative overflow-hidden">
          ...
          <div className="hidden md:flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full border-4 border-[#2C1810] flex-shrink-0 z-10">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-7 h-7 sm:w-8 sm:h-8 text-[#2C1810]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2.5}
