export default function Footer() {
  return (
    <footer className="bg-[#2C1810] text-white px-4 sm:px-6 pt-10 pb-6">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2.5">
              {/* Instagram */}
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#FF2D7A] transition-colors flex items-center justify-center" aria-label="Instagram">
              ...
              {/* Facebook */}
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#FF2D7A] transition-colors flex items-center justify-center" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              {/* TikTok */}
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#FF2D7A] transition-colors flex items-center justify-center" aria-label="TikTok">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#FF2D7A] transition-colors flex items-center justify-center" aria-label="YouTube">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-4 border-t border-white/10 text-center text-gray-400 text-xs">
